...
abstract class AbstractDuration implements Duration {
  ...
  public String format(String template) {
      ...
      if (formatter) {
        switch (c) {
          ...
          case 'm':
            ...
            break;
          case 'M':
            result += String.format("%02d", time / 60 % 60);
            break;
          case 's':
            result += time % 60;
            break;
          ...
          case '%':
            ...
            break;
          default:
            throw new IllegalArgumentException("Illegal Specifier");
        }
        formatter = false;
      } else if (c.equals('%')) {
        formatter = true;
    ...
    if (formatter) {
      throw new IllegalArgumentException("Solo Formatter %");
    }
    return result;
  }
